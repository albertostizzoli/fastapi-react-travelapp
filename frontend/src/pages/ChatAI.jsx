...
function ChatAI() {
    ...
    return (
        <div className="flex">
            ...
            {/* SIDEBAR */}
            <aside className="w-52 ms-6 flex flex-col mt-12 bg-white/10 dark:bg-white/5 backdrop-blur-3xl
            border border-white/20 dark:border-white/10 shadow-[0_8px_32px_rgba(255,255,255,0.1)] rounded-3xl">
                ...
                <div className="p-4 border-t border-white/20">
                    <button
                        ...
                        className="bg-linear-to-br from-green-600 to-teal-500 dark:from-green-600/70 dark:to-teal-500/70
            ...
            <motion.div
                ...
                <div className="p-3 sm:p-4 flex flex-col sm:flex-row items-center gap-3 backdrop-blur-xl">
                    ...
                    <motion.button
                        ...
                        <FaCompass size={20} />
                        {isRecommending ? "Un attimo" : "Consigliami"}
                    </motion.button>
                </div>
            </motion.div>
        </div>
