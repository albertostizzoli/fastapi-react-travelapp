...
function ModalDeleteChat({ isOpen, onConfirm, onCancel, chat }) {
  return (
        ...
        <motion.div
          ...
          <motion.div
            ...
            <h2 className="text-2xl font-extrabold mb-6 text-white drop-shadow-lg">
               Vuoi davvero cancellare la chat <span className="text-red-400 dark:text-red-500">"{chat?.title}"</span>?
            </h2>

            {/* Descrizione */}
            <p className="text-white mb-8 text-2sm drop-shadow-sm">
              La chat verrà rimossa <span className="text-red-400 dark:text-red-500 font-semibold">definitivamente</span><br />
              dall'elenco. Questa azione non può essere annullata.
            </p>
