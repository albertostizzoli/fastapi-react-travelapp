            ...
            {isOpen && (
                <motion.div
                    ...
                    <motion.div
                        ...
                        {/* Lista categorie */}
                        <div className="space-y-6 flex-1 overflow-y-auto p-3 scrollbar">
                            {travellers.map((cat) => (
                                <div key={cat.category}>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                        {cat.experiences.map((experience) => (
                                            <label
                                                key={experience}
                                                className={`font-semibold flex items-center justify-center text-center px-4 py-2 border 
                                                        rounded-2xl cursor-pointer text-sm transition-all backdrop-blur-md ${categories.includes(experience)
                                                        ? "bg-linear-to-br from-blue-600 to-red-600 dark:from-blue-600/70 dark:to-red-500/70 backdrop-blur-md border border-white text-white shadow-lg transition-all duration-100 ease-in-out hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
